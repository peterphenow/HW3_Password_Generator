...
//when Generate Password button clicked, run following code
...
selectedOptions = "";
  ...
  if (lowerQuery === true) {
    if (upperQuery === true) {
      if (symbolQuery === true) {
        if (numsQuery === true) { //1 runs if user wants all 4 options
        ...
        } else { //2 runs if user wants lower, upper, symbols, not numbers
          builtPassword += lowerCase[Math.floor(Math.random() * lowerCase.length)];
          builtPassword += upperCase[Math.floor(Math.random() * upperCase.length)];
          builtPassword += symbols[Math.floor(Math.random() * symbols.length)];
      ...
      } else if (numsQuery === true) { //3 runs if user wants lower, upper, not symbols, numbers
        builtPassword += lowerCase[Math.floor(Math.random() * lowerCase.length)];
        builtPassword += upperCase[Math.floor(Math.random() * upperCase.length)];
        builtPassword += nums[Math.floor(Math.random() * nums.length)];
      ...
      } else { //4 runs if user wants lower, upper, not symbols, not numbers
        builtPassword += lowerCase[Math.floor(Math.random() * lowerCase.length)];
        builtPassword += upperCase[Math.floor(Math.random() * upperCase.length)];
    ...
    } else if (symbolQuery === true) { //5 runs if user wants lower, not upper, symbols, numbers
      if (numsQuery === true) {
        builtPassword += lowerCase[Math.floor(Math.random() * lowerCase.length)];
        builtPassword += symbols[Math.floor(Math.random() * symbols.length)];
        builtPassword += nums[Math.floor(Math.random() * nums.length)];
      ...
      } else { //6 runs if user wants lower, not upper, symbols, not numbers
        builtPassword += lowerCase[Math.floor(Math.random() * lowerCase.length)];
        builtPassword += symbols[Math.floor(Math.random() * symbols.length)];
    ...
    } else if (numsQuery === true) { //7 runs if user wants lower, not upper, not symbols, numbers
      builtPassword += lowerCase[Math.floor(Math.random() * lowerCase.length)];
      builtPassword += nums[Math.floor(Math.random() * nums.length)];
    ...
    } else { //8 runs is user wants lower, not upper, not symbols, not numbers
      builtPassword += lowerCase[Math.floor(Math.random() * lowerCase.length)];
    ...
    if (symbolQuery === true) {
      if (numsQuery === true) { //9 runs if user wants no lower, upper, symbol, nums
        builtPassword += upperCase[Math.floor(Math.random() * upperCase.length)];
        builtPassword += symbols[Math.floor(Math.random() * symbols.length)];
        builtPassword += nums[Math.floor(Math.random() * nums.length)];
      ...
      } else { //10 runs if user wants no lower, upper, symbol, no nums
        builtPassword += upperCase[Math.floor(Math.random() * upperCase.length)];
        builtPassword += symbols[Math.floor(Math.random() * symbols.length)];
    ...
    } else if (numsQuery === true) { //11 runs if user wants no lower, upper, no symbol, nums
      builtPassword += upperCase[Math.floor(Math.random() * upperCase.length)];
      builtPassword += nums[Math.floor(Math.random() * nums.length)];
    ...
    } else { //12 runs if user wants no lower, upper, no symbol, no nums
      builtPassword += upperCase[Math.floor(Math.random() * upperCase.length)];
    ...
    if (numsQuery === true) { //13 runs if user wants no lower, no upper, symbol, nums
      builtPassword += symbols[Math.floor(Math.random() * symbols.length)];
      builtPassword += nums[Math.floor(Math.random() * nums.length)];
    ...
    } else { //14 runs if user wants no lower, no upper, symbols, no nums
      builtPassword += symbols[Math.floor(Math.random() * symbols.length)];
  ...
  } else if (numsQuery === true) { //15 runs if user wants no lower, no upper, no symbol, nums
    builtPassword += nums[Math.floor(Math.random() * nums.length)];
    selectedOptions = nums;
    for(let i=1; i<pwLength; i++) {
      builtPassword += selectedOptions[Math.floor(Math.random() * selectedOptions.length)]; 
    }
  } else { //16 runs if user doesn't select any set of character to use
  ...
  //just logging to check that everything works as expected in console
